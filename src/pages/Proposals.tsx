...
import { FileText, Lightbulb, GraduationCap, ClipboardCheck, Users, Star, ChevronDown } from 'lucide-react'
...
export default function Proposals() {
  const [active, setActive] = useState(() => proposals.find(p => p.recommended)?.id ?? proposals[0]?.id)
